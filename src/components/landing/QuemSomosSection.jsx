  ...
  return (
    <section id="quem-somos" className="py-20 md:py-32 bg-white text-[#00204E]">
      <div className="container mx-auto px-4">
        <motion.div ref={ref} initial={{ opacity: 0, y: 50 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
            <h2 className="text-2xl font-bold text-center md:hidden mb-4 font-heading">
              Prazer, Lissa Ramos
            </h2>

            <motion.div initial={{ opacity: 0, x: -30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.2, duration: 0.8 }} className="flex justify-center md:w-1/2">
              <div className="relative">
                <div className="absolute inset-0 bg-[#B59459] rounded-2xl transform -rotate-3"></div>
                <img 
                  src="/lissaramosquemsomos.heic"
                  alt="Lissa Ramos" 
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.4, duration: 0.8 }} className="md:w-1/2">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.6, duration: 0.8 }} className="text-center mt-16">
